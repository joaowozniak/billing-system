...
class Constants:
    ...
    def REVENUES_ENDPOINT(id: int, date: datetime.date) -> str: 
        return f"https://billing.eng-test.wayflyer.com/v2/customers/{id}/revenues/{date}"
    ...
    def BILLING_COMPLETE_ENDPOINT(id: str) -> str: 
        return f"https://billing.eng-test.wayflyer.com/v2/advances/{id}/billing_complete"
